...
This project is a simple web application that provides weather information using the OpenWeather API. It was developed as part of my summer internship.
...
1. **Clone the repository**
   ...
   ```sh
   git clone https://github.com/Shashank-bachi/weatherapp.git
   cd weather-app
   ```
